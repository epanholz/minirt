...
#    Updated: 2020/07/01 13:09:16 by epanholz      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #

NAME = minirt

SRC = test_main.c read_file.c get_scene.c check_scene.c check_scene_utils.c object_list.c object_list_traverse.c
