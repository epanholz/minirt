...
#    Updated: 2020/07/03 12:30:24 by epanholz      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #

NAME = minirt

SRC = test_main.c read_file.c get_scene.c check_scene.c check_scene_utils.c object_list.c object_list_traverse.c vector_library.c
